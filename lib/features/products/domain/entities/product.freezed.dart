...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, price: $price, imageUrl: $imageUrl, description: $description, category: $category, rating: $rating, reviewCount: $reviewCount, isInStock: $isInStock)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, price, imageUrl,
      description, category, rating, reviewCount, isInStock);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      required final bool isInStock}) = _$ProductImpl;
